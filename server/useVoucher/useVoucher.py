...
def processUseVoucher(use):
    ...
    useVoucher_result = invoke_http(
        wallet_URL+"/use/"+str(use["walletID"])+"/"+use["voucher_code"], method='PATCH')
    ...
    if code not in range(200, 300):
        ...
        my_object = {
            "email": use["email"], "message": returnMessage, "subject": "Voucher Usage"}
